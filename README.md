...
Шаг 5 обращается к внешнему сайту. Если сайт недоступен — бот всё равно запустится, а соответствующий раздел покажет заглушку до следующего перезапуска.
...
Контент франшизы синхронизируется при старте бота. Каталог фильмов теперь не парсится автоматически и обновляется только вручную. Для принудительной синхронизации без перезапуска:

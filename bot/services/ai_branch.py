...
_COMPARE_FOLLOWUP_HINTS = (
    ...
    "количество франшиз", "сколько франшиз", "число франшиз", "франчайзи",
    "партнеры", "партнёры", "сеть", "масштаб сети", "страны", "охват",
    "про франшизу", "про количество", "по количеству франшиз",
)
